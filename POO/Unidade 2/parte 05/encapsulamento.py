# encapsulamento: publico -> exemplo_publico; protegido -> _atribito_protegido; privado -> __atributo_privado # noqa
...
print(f'Preço antigo: R$ {tv_1.__preco:.2f}')
tv_1.atualizar_preco(2160)
print(f'Preço novo: R$ {tv_1.__preco:.2f}')
