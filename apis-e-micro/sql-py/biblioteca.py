...
"INSERT INTO livro (id_livro, descricao) VALUES (4, 'Harry Potter')"
...
"UPDATE livro SET id_aluno=2 WHERE id_livro = 4"
#       nome tabela
#                valor que eu quero
#                colocar na coluna
#                                  linhas que eu quero editar
...
#None é o valor "vazio" ou "inválido" do python
...
"SELECT * FROM livro where id_aluno ISNULL;"
def livros_parados():
    with engine.connect() as con:    
...
"""
SELECT id_livro, id_aluno, descricao FROM 
